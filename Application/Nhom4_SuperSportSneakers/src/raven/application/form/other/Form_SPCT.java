...
public class Form_SPCT extends javax.swing.JPanel {
    ...
    public Form_SPCT() {
        ...
        listSPCT = sanPhamCT_Repository.get(page, 5);
        //
    ...
    private void initComponents() {
        ...
        cboTrangThai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trạng Thái" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(btnQRScan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cboKichThuoc, cboMauSac, cboThuongHieu, cboTrangThai, txtSearch});

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 40, 1030, -1));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cboTrangThaiSanPham, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(soTrang1, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (page >= 1) {
            ...
            fillToTableSanPhamChiTiet(sanPhamCT_Repository.get(page, 4));
        } else {
            page = 1;
        }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        fillToTableSanPhamChiTiet(sanPhamCT_Repository.get(1, 4));
        soTrang.setText(page + " / " + gioiHanPage);
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        fillToTableSanPhamChiTiet(sanPhamCT_Repository.get(gioiHanPage, 4));
        soTrang.setText(page + " / " + gioiHanPage);
    ...
    private void btnAdd_SanPhamChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd_SanPhamChiTietActionPerformed
        ...
        if (spct == null) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                listSPCT = sanPhamCT_Repository.getToAll();
                fillToTableSanPhamChiTiet(listSPCT);
