...
public class Form_ThuongHieu extends javax.swing.JPanel {
    ...
    private void fillToTable(List<ThuongHieu> list) {
        ...
        for (ThuongHieu i : list) {
            ...
            row[3] = (i.getTrangThai() == 0) ? "Đang Hợp Tác" : "Ngưng Hợp Tác";
            tblModel.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        rboCon_Search.setText("Đang Hợp Tác");
        ...
        rboKhong_search.setText("Ngưng Hợp Tác");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (ms == null) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                list = msr.get(page, 5);
                fillToTable(list);
                Notifications.getInstance().show(Notifications.Type.INFO, Notifications.Location.TOP_CENTER, "Bạn đã update thành công thương hiệu.");
            } else if (check == JOptionPane.NO_OPTION) {
                // Người dùng chọn "Không"
    ...
    private void tblThuongHieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblThuongHieuMouseClicked
        ...
        if (index < 0) {
            ...
            if (tblThuongHieu.getValueAt(index, 3).equals("Đang Hợp Tác")) {
                rboCon.setSelected(true);
            } else if (tblThuongHieu.getValueAt(index, 3).equals("Ngưng Hợp Tác")) {
